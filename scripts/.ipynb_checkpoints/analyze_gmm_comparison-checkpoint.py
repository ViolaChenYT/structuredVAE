...
def main():
    ...
    MAX_PATHS_TO_ANALYZE = 200  # Limit number of paths for UMAP/PCA analysis (can be slow)
    ...
    if UMAP_AVAILABLE:
        ...
        # Limit to MAX_PATHS_TO_ANALYZE paths
        if len(common_paths) > MAX_PATHS_TO_ANALYZE:
            import random
            random.seed(42)
    ...
    # Limit to MAX_PATHS_TO_ANALYZE for correlation computation
